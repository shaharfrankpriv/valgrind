...
void test_set_used()
{
	...
	printf
	    ("set used: addr = %lu, size = %d, cache_line_sz = %d:  w = %s d = %d\n",
	     t->a, t->s, t->l, s, d);
...
int main(int argc, char **argv)
{
    ...
    test_set_used();
    /*d = set_used(0, 4, 64, &w);
       printf("{0, 4, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(2, 4, 64, &w);
       printf("{2, 4, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(0, 5, 64, &w);
       printf("{0, 5, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(32, 4, 64, &w);
       printf("{32, 4, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(32, 8, 64, &w);
       printf("{32, 8, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(32, 16, 64, &w);
       printf("{32, 16, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(32, 12, 64, &w);
       printf("{32, 12, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(60, 8, 64, &w);
       printf("{60, 8, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(62, 4, 64, &w);
       printf("{62, 4, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(62, 8, 64, &w);
       printf("{62, 8, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(62, 8, 64, &w);
       printf("{62, 8, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(56, 10, 64, &w);
       printf("{56, 10, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
       d = set_used(56, 20, 64, &w);
       printf("{56, 20, 64:  w = %s d = %d\n", tobin(w, buf, words), d);
     */
    return 0;
}
